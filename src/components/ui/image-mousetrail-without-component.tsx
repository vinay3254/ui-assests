...
export default function ImageMouseTrail3() {
  ...
  return (
    <section
      ...
      ref={containerRef}
      className='grid place-content-center h-[600px] w-full bg-[#e0dfdf] dark:bg-zinc-900 text-foreground relative overflow-hidden rounded-lg'
    >
      ...
      <article className='relative z-20 mix-blend-difference text-white'>
